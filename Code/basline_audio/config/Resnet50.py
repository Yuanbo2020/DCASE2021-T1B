...
config = {}
data_train_opt = {}
config["data_dir"] = "/home/share/tyz/dataset_2fps"
config["device_ids"] = [0]

data_train_opt['batch_size'] = 32
data_train_opt['epoch'] = 50
data_train_opt['split'] = 'train'
data_train_opt['lr'] = 0.001
...
feat_training_file = '/home/share/tyz/experiments/Our_baseline_audio/lr{}_batch{}'.format(data_train_opt['lr'],data_train_opt['batch_size'])
