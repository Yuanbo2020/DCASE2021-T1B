...
import os
import imp
from basline_audio import model
import math
import time
...
class ImageClassify(object):
    def __init__(self):
        ...
        self.best = 0
        self.train_dataset = dataloader.Audio_Data(config["data_dir"],"train")
        ...
        self.valid_dataset = dataloader.Audio_Data(config["data_dir"],"val")
